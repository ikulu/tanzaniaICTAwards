  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Logg in usrnam</a>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
              <?php 
                  $sql1 = "SELECT distinct * FROM wapendekezaNAwapendekezwa";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
              <?php 
                  $sql1 = "SELECT max(pendekezwaID) FROM wapendekezaNAwapendekezwa";
