...
<head>
  ...
  <title>Tanzania ICT Awards | Verified Nominees List</title>
    ...
    <section class="content">
      ...
      <table id="table_id" class="display table table-hover text-nowrap">
        <thead style='color:white'>
          <?php 
          $id = $_GET['id'];
          $nomineeDetails = "SELECT name,url,phone,descr,vtime FROM verify WHERE wapendekezwa_fk = '$id' ORDER BY vtime ASC";
